...
extern void HAL_setupAdc(uint16_t aHandle, uint16_t aAdc, const AIN_AdcParams_t *aInParams);
extern AIN_ChannelParams_t* HAL_getDefaultAinChannelParams();
extern void HAL_setupAnalogIn(uint16_t aHandle, uint16_t aChannel, uint16_t aResourceNumber,  const AIN_ChannelParams_t *aParams);
extern void HAL_setupAnalogInF(uint16_t aHandle, uint16_t aChannel, uint16_t aResourceNumber, const AIN_ChannelParams_t *aParams, float scale, float offset);
...
extern uint16_t HAL_getAnalogIn(uint16_t aHandle, uint16_t aChannel);
extern float HAL_getAnalogInF(uint16_t aHandle, uint16_t aChannel);
