...
#ifdef Timer1_Select
volatile uint16_t *TimerRA = &Timer_RegisterA;
volatile uint16_t *TimerRB = &Timer_RegisterB;
volatile uint16_t *TimerRM = &Timer_RegisterMask;
