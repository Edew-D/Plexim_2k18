/*
 * C-Script file for: Blink/C-Script
 * Generated with   : PLECS 4.2.0-DEV
 * Generated on     : 12 Jul 2018 12:11:49
 */
...
void Blink_0_cScriptStart(const struct CScriptStruct *cScriptStruct)
{
}

void Blink_0_cScriptOutput(const struct CScriptStruct *cScriptStruct)
{
   Output(0)=Input(0);
}

void Blink_0_cScriptUpdate(const struct CScriptStruct *cScriptStruct)
{
}

void Blink_0_cScriptDerivative(const struct CScriptStruct *cScriptStruct)
{
}

void Blink_0_cScriptTerminate(const struct CScriptStruct *cScriptStruct)
{
}
